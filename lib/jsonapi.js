...
// lineLogger(config, generateJwt, checkJwtMiddleware, model, queryAsync, m, '####');
  ...
  router.post('/signin', (req, res) => {
    ...
    lineLogger(req.body, identifier, email, password);
  ...
  function getInsertOrUpdate(insertOrUpdateQuery) {
    ...
    return (req, res) => {
      ...
      const { tableName, kebabPlural, modelName, allAttributes, relationshipAttributes, deferredManyToMany, deferredManyToOne, deferredOneToOne } = req[REQ_DATA_KEY];
